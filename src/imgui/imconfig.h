...
// VKIntox overlay: disable unused features to reduce binary size (~25KB) and
...
#define IMGUI_DISABLE_OBSOLETE_FUNCTIONS                    // Remove deprecated API to avoid accidental use and reduce code size.
